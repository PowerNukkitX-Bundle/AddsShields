...
public class WitherShield extends ShieldBase implements CustomItem {
    public WitherShield() {
        super("Wither Skely Shield");
    }
    ...
    public String getNamespaceId() {//物品标识符
        return "wither_skely:shield";
    }
    @Override
    public String getTextureName() { return "wither";}
}