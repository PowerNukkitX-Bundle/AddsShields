...
public class SculkShriekerShield extends ShieldBase implements CustomItem {
    public SculkShriekerShield() {
        super("Sculk Shrieker Shield");
    }
