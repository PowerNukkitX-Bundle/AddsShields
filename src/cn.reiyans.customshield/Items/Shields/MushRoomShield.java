...
public class MushRoomShield extends ShieldBase implements CustomItem {
    public MushRoomShield() {
        super("Mushroom Shield");
    }
    ...
    public String getNamespaceId() {//物品标识符
        return "mushroom:shield";
    }
    @Override
    public String getTextureName() { return "mushroom";}
}