...
public class NetheriteCrimsonShield extends ShieldBase implements CustomItem {
    public NetheriteCrimsonShield() {
        super("Netherite Crimson Shield");
    }
    ...
    public String getNamespaceId() {//物品标识符
        return "netherite_crimson:shield";
    }
    @Override
