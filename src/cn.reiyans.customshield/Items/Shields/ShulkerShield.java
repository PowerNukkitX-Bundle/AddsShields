...
public class ShulkerShield extends ShieldBase implements CustomItem {
    public ShulkerShield() {
        super("Shulker Shield");
    }
    ...
    public String getNamespaceId() {//物品标识符
        return "shulker:shield";
    }
    @Override
    public String getTextureName() { return "shulker";}
}