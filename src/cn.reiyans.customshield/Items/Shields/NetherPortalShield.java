...
public class NetherPortalShield extends ShieldBase implements CustomItem {
    public NetherPortalShield() {
        super("Nether Portal Shield");
    }
    ...
    @Override
    public String getTextureName() { return "nether";}
}